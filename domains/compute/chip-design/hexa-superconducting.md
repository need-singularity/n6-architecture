...
<details>
<summary>Mk.I — 2026~2030 소프트웨어 레퍼런스 + SPICE</summary>

JSim/WRspice RSFQ SPICE 레퍼런스 + Python cell library 시뮬. σ=12 cell/block, τ=4 파이프 수론 자동 유도. §7 10 서브섹션 정직성 검증 통과 (Φ₀ INDEPENDENT 명시 포함). `hexa-superconducting` 문서 canonical v1 확정.
