...
| 🛸 | 천장확인 | ver | 완성제품 | 핵심 | 링크 |
|:--:|:--:|:---:|---------|------|------|
| 10 | ✅ | v2 | **궁극의 SF 추진 (HEXA-SF)** | 워프+차원도약+UFO 통합. BT-358~360 워프-차원 돌파, Mk.II~V 전체 버전업: 차원센서(τ=4ch)→워프필드(σ=12 Casimir)→차원접이(COP=φ=2)→WDCE(σ-φ)²=100c. α Centauri 16일. 검증 26/26 PASS | [링크](docs/sf/goal.md) |
