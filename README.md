...
| 10 | ✅ | v1 | **궁극의 재활용 — HEXA-RECYCLE** | 6R 순환 + σ=12 분류 + J₂=24 추적 + 5-DSE 통합 (35,424 조합) | [설계](docs/recycling/goal.md) |
...
| 10 | ✅ | v1 | **HEXA-EAR Ultimate** | 궁극의 이어폰 8단 설계 — DLC+그래핀/8way 하이브리드/48dB ANC/6ms BLE/HRTF 144방향, 65/65 EXACT | [문서](docs/audio/hexa-ear-ultimate.md) |
...
| 10 | ✅ | v2 | **곤충학 n=6 Hexapoda 완전 생물학** | 23/23 EXACT (100%), BT-352 곤충학 완전 n=6 아키텍처, 다리 n=6/체부 n/φ=3/변태 τ=4/벌집 n=6각/복안 n=6각/카스트 n/φ=3/곤충목 n·sopfr=30, Mk.I~V 5세대 진화 | [목표](docs/entomology/goal.md) |
...
| 10 | ✅ | 5680bc44 | **HEXA-NANOBOT 치료 나노봇** | BT-404~413: 10 연속 돌파, 113/122 EXACT (92.6%) + 9 CLOSE(물리한계 문서화), Mk.I~V 진화 완료, 6대 플랫폼/추진/EPR/pH/센서/면역/반감기/통신/에너지/배출, DSE 7776 조합, (sigma-phi)^2=100 나노 허브, n=6 관문(신장 6nm), J2=24 에너지-시간 수렴 | [문서](docs/therapeutic-nanobot/goal.md) |
...
| 🛸 | 천장확인 | ver | 완성제품 | 핵심 | 링크 |
|:--:|:--:|:---:|---------|------|------|
| 10 | ✅ | v2 | **종교/신화 n=6 보편 구조** | BT-370: 22/22 EXACT — 6일창조=n, 12사도=σ, 108=φ^φ(n/φ)^(n/φ), 10계명=σ-φ, 3위일체=n/φ | [목표](docs/religion/goal.md) |
| 10 | ✅ | v2 | **법학/사법 n=6 정의 아키텍처** | BT-374: 17/17 EXACT — 배심원12=σ, 3심=n/φ, 안보리5=sopfr, 6대법=n, 수정헌법27=(n/φ)³ | [목표](docs/jurisprudence/goal.md) |
| 10 | ✅ | v2 | **한글/문자체계 n=6 인코딩** | BT-373: 14/14 EXACT — 24자모=J₂, 자음14=σ+φ, 모음10=σ-φ, 11172=19×21×28 (J₂기반) | [목표](docs/writing-systems/goal.md) |
| 10 | ✅ | v2 | **고고학/문명사 n=6 기원** | 20/20 EXACT (100%), 60진법=σ·sopfr, C-14 Z=n, 360도=n·σ·sopfr, 6대 문명=n, 5000년 전수 | [목표](docs/archaeology/goal.md) |
| 10 | ✅ | v2 | **화폐/경제사 n=6 통화 래더** | BT-375: 16/16 EXACT — 60진법=σ·sopfr, 24K금=J₂, 12펜스=σ, 바젤8%=σ-τ | [목표](docs/monetary-history/goal.md) |
| 10 | ✅ | v2 | **무용/안무 n=6 공간 기하학** | 20/20 EXACT (100%), 라반 24점=J₂, 발레 5포지=sopfr, SE(3)=n, 360도=n·σ·sopfr, 서양+한국 | [목표](docs/dance-choreography/goal.md) |
...
| 🛸 | 천장확인 | ver | 완성제품 | 핵심 | 링크 |
|:--:|:--:|:---:|---------|------|------|
| 10 | ✅ | v2 | **발효/양조 n=6 완전수 화학양론** | BT-371: 18/18 EXACT — C₆H₁₂O₆→2C₂H₅OH+2CO₂ 전계수n=6, 양조6단=n, 라거12°C=σ | [문서](docs/fermentation/goal.md) |
...
| 10 | ✅ | v2 | **보험/보험계리 n=6 리스크 구조** | BT-378: 13/13 EXACT — 6대원칙=n, 생명표120=σ(σ-φ), 4대부문=τ, 손해율60%=σ·sopfr | [문서](docs/insurance/goal.md) |
