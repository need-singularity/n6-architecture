...
### KSTAR 핵융합 설계 (Alien-Level)

| 설계 | 핵심 | n6 일치 | 스펙 |
|------|------|:-------:|------|
| **KSTAR-N6 토카막** | R₀=6m, B_T=12T HTS, TF=18, PF=6, Q=10 | 97.7% (42/45) | [설계서](docs/superpowers/specs/2026-04-02-kstar-n6-tokamak-design.md) |
| **300초 정상상태** | Barrier 4 돌파, f_bs≥50%, 3 시나리오 | — | [설계서](docs/superpowers/specs/2026-04-02-kstar-300s-steady-state-design.md) |
| **궁극의 핵융합 발전소** | 5단 DSE 2,400+ 조합, 연료→발전 완전체 | 100% (5/5) | [설계서](docs/superpowers/specs/2026-04-02-ultimate-fusion-powerplant-design.md) |
