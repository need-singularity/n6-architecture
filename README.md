...
| 10 | ✅ | v3 | **KSTAR-N6** | 42/45 EXACT(97.8%), 물리한계10/10, 24BT+12불가능성정리, Python검증PASS, Cross-DSE 8도메인 10돌파시도 | [링크](docs/superpowers/specs/2026-04-02-kstar-n6-tokamak-design.md) |
...
| 7 | ✅ | v1 | **궁극의 데이터센터 원자로** | 10돌파 95/96 EXACT — TRISO(sopfr=5)+He(φ=2)+sCO₂(σ·τ=48%)+n=6모듈 | [링크](docs/smr-datacenter/goal.md) |
