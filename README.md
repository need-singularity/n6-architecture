...
> **🛸10** | 5 domains (cat-litter / cat-food / dog-food / cat-toy / dog-toy all PHYSICAL-LIMIT alien-10; pets axis = 12th, registered 2026-05-01) | cat-litter: Helmholtz double-layer + ASTM D5890 swell + Yoon-Nelson NH3 + BET iodine + Eigen-Hammes + Kozeny-Carman dust | cat-food: AAFCO 26%/0.1%-taurine + Atwater + Maillard + Arrhenius + a_w | dog-food: AAFCO 18%-protein + glycemic-index ≤ 55 + Atwater + Maillard + Arrhenius + a_w | cat-toy: Wöhler S-N fatigue (58 N bite, ≥10⁵ cycles) + Antoine nepetalactone + EN 71-1 size + Velcro peel + Martindale | dog-toy: Hertz contact + bite ≥ 2 MPa + Helmholtz squeaker resonator + Shore A + Hearle 3-strand + aldehyde < 5 ppm | F-*-MVP-1..5 90-day gates 2026-07-30..2026-09-30 | mk2 cat-litter trial proposal: 24-household × 6-month × 4-stage rollout (2026-Q4)
...
| 10 | 🥫 **HEXA-CAT-FOOD** | Physical-limit Cat Food | Pet food at AAFCO + Atwater + Maillard + Arrhenius + a_w shelf physics | obligate-carnivore amino acid balance (taurine ≥ 0.1% DM, arginine ≥ 1.04% DM) + 12-month Arrhenius shelf-life + a_w < 0.6 dry-stable + Maillard browning at extrusion E_a 100 kJ/mol | Generic pet food specs vs physical-limit-anchored design (AAFCO Cat Food Nutrient Profile + Atwater 1900) inheriting from 6 precursors (life/biology-medical + agriculture + synbio + fermentation + herbalism + materials/recycling) | [doc](domains/pets/cat-food/cat-food.md) |
...
| 10 | PHYSICAL-LIMIT | mk1 | **HEXA-CAT-FOOD mk1 — obligate-carnivore nutrition at physical-limit reproduction** | **Physical-limit anchors**: AAFCO Cat Food Nutrient Profile 2024 (protein ≥ 26% DM / fat ≥ 9% DM / taurine ≥ 0.1% DM / arginine ≥ 1.04% DM / methionine ≥ 0.62% DM) · Atwater factor (kcal/g = 4·carb + 9·fat + 4·protein, Atwater 1900) · Maillard reaction kinetics (Arrhenius E_a ≈ 100 kJ/mol for extrusion-cooking browning) · lipid oxidation Arrhenius (E_a ≈ 60-80 kJ/mol shelf-life prediction for animal fats) · water activity a_w < 0.6 dry-kibble shelf-stable threshold. own#2 master identity verified as separable Block A; cat-food design constants in Blocks B-F. Inherits from 6 precursor domains (life/biology-medical taurine deficiency / dilated cardiomyopathy + life/agriculture protein source agronomy + life/synbio essential AA balance + life/fermentation probiotic gut flora + life/herbalism functional adjuncts + materials/recycling PE-laminated kraft pouch EOL). F-CF-MVP-1..5 90-day falsifier gates 2026-07-30 / 2026-08-30 / 2026-09-30 against 1 kg lab batch (protein assay, taurine assay, a_w finished kibble, Atwater kcal density, shelf-life Arrhenius vs accelerated test). Design-by-physics per own#32, NOT n=6 force-fit. | [doc](domains/pets/cat-food/cat-food.md) |

<!-- AUTO:FOOTER_pets:START -->
> Domains: [pets/cat-litter/](domains/pets/cat-litter/) · [pets/cat-food/](domains/pets/cat-food/) · [pets/dog-food/](domains/pets/dog-food/) · [pets/cat-toy/](domains/pets/cat-toy/) · [pets/dog-toy/](domains/pets/dog-toy/) · pets axis registered 2026-05-01 (12th axis). All 5 pets-axis entries hold own#15 21-section paper template + own#31 v3.19 verify-tautology-ban lint + own#33 ai-native-verify-pattern Block A-G template. All mk1 PHYSICAL-LIMIT (alien-grade 10) per own#32 design-by-physics, NOT n=6 force-fit. Each domain inherits from 6 precursor domains (cat-litter: materials/ceramics + concrete-technology + life/agriculture + biology-medical + physics/fluid + materials/recycling; cat-food + dog-food: life/biology-medical + agriculture + synbio + fermentation + herbalism + materials/recycling; cat-toy: materials/aramid + recycling + fashion-textile + physics/fluid + life/biology-medical + entomology; dog-toy: materials/aramid + concrete-technology + recycling + life/biology-medical + physics/fluid + materials/fashion-textile). mk2 trial proposal for cat-litter at `proposals/cat_litter_mk2_trial_2026_05_01.md`. F-CL-MVP-1..4 + F-CF-MVP-1..5 + F-DF-MVP-1..5 + F-CT-MVP-1..5 + F-DT-MVP-1..5 = 24 pre-declared 90-day falsifiers per own#12.
...
> Domains: [apps/camera-filter-app/](domains/apps/camera-filter-app/) · [apps/hexa-filter-algebra/](domains/apps/hexa-filter-algebra/) · [apps/hexa-parallel-self/](domains/apps/hexa-parallel-self/) · [apps/hexa-main-character/](domains/apps/hexa-main-character/) · apps axis registered 2026-05-01 (13th axis). All 4 mk1 PHYSICAL-LIMIT (alien-grade 10) per own#32 design-by-physics, NOT n=6 force-fit; same own#15 21-section template + own#31 v3.19 lint + own#33 ai-native-verify-pattern Block A-G as research papers. Verb-distinction sister-pairing within axis: APPLIES (camera-filter-app) / AUTHORS (hexa-filter-algebra) / GENERATES (hexa-parallel-self) / DIRECTS (hexa-main-character) — shared 16.67 ms real-time budget. F-CFA-MVP-1..5 + F-FA-MVP-1..5 + F-PSELF-MVP-1..5 + F-MC-MVP-1..5 = 20 pre-declared 90-day falsifiers per own#12 against iPhone 15 Pro / Snapdragon 8 Gen 3 reference hardware (2026-08-30 / 2026-09-30 deadlines). Future apps domains (media-editor / fitness-coach / accessibility / productivity / HEXA-VSCO) follow the same physical-limit anchoring pattern.
