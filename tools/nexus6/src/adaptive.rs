...
//!
//! Persistence: ~/.nexus6/adaptive_weights.json
//!
...
impl AdaptiveWeights {
    /// Load from ~/.nexus6/adaptive_weights.json, or create default.
    pub fn load() -> Self {
    ...
    /// Save to ~/.nexus6/adaptive_weights.json.
    pub fn save(&self) {
        let path = Self::persistence_path();
    ...
    fn persistence_path() -> PathBuf {
        ...
        PathBuf::from(home).join(".nexus6").join("adaptive_weights.json")
    }
