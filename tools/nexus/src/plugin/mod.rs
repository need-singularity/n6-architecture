...
mod tests {
    ...
    fn test_plugin_registry_register_and_lookup() {
        let mut registry = PluginRegistry::new("/tmp/nexus_plugins_test");
    ...
    fn test_plugin_registry_list_by_type() {
        let mut registry = PluginRegistry::new("/tmp/nexus_plugins_test2");
    ...
    fn test_plugin_registry_validate() {
        let mut registry = PluginRegistry::new("/tmp/nexus_plugins_test3");
    ...
    fn test_plugin_registry_summary() {
        let mut registry = PluginRegistry::new("/tmp/nexus_plugins_test4");
