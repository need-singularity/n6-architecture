...
mod tests {
    ...
    fn test_collector_record_and_stats() {
        let mut collector = FeedbackCollector::new("/tmp/nexus_test_feedback.jsonl");
    ...
    fn test_collector_net_score_and_top_discoveries() {
        let mut collector = FeedbackCollector::new("/tmp/nexus_test_fb2.jsonl");
    ...
    fn test_collector_serialize_parse_roundtrip() {
        let mut collector = FeedbackCollector::new("/tmp/nexus_test_fb3.jsonl");
        ...
        let mut collector2 = FeedbackCollector::new("/tmp/nexus_test_fb3.jsonl");
        collector2.load();
        ...
        // Cleanup
        let _ = std::fs::remove_file("/tmp/nexus_test_fb3.jsonl");
    }
