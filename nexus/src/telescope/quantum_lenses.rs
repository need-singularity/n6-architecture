...
pub fn quantum_topology_lens_entries() -> Vec<LensEntry> {
    vec![
        ...
        // ══════════════════════════════════════════
        LensEntry { name: "design_pattern".into(), category: LensCategory::Extended, description: "Detect GoF/SOLID design patterns and architectural motifs in system structure".into(), domain_affinity: vec!["software".into(), "architecture".into(), "ai".into(), "programming-language".into()], complementary: vec!["code_smell".into(), "refactoring_opportunity".into()] },
        ...
        LensEntry { name: "type_system_lens".into(), category: LensCategory::Extended, description: "Analyze type system structure — generics depth, trait bounds, type-level computation".into(), domain_affinity: vec!["software".into(), "type_theory".into(), "verification".into(), "programming-language".into()], complementary: vec!["api_surface".into(), "design_pattern".into()] },
        LensEntry { name: "concurrency_pattern".into(), category: LensCategory::Extended, description: "Detect concurrency patterns — lock-free, actor, CSP, fork-join, async/await".into(), domain_affinity: vec!["software".into(), "concurrency".into(), "performance".into(), "compiler-os".into()], complementary: vec!["memory_model_sw".into(), "design_pattern".into()] },
