...
```
  ...
  ║  PUE 목표                     ║  1.0 = μ (무손실)               ║
  ║  양자 큐비트 운전 온도          ║  20 mK = J₂-τ                   ║
  ║  Total n=6 EXACT               ║  14/15 (93.3%)                  ║
  ╚════════════════════════════════╩═════════════════════════════════╝
```
...
|----------|-----|---------|-------|
| 도시당 핵융합로 수 | 6 | n=6 | O |
| 단위 출력 | ~200 MWe (ARC급) | (σ-φ)²·φ=100·2=200 | O |
...
```
  ...
  │         │         │ 6tape=n│        │         │         │ Q>φ=2  │ PUE→μ  │
  ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
  │n6: 93%  │n6: 83%  │n6: 90%  │n6: 86%  │n6: 90%  │n6: 92%  │n6: 87%  │n6: 93%  │
  └─────────┴─────────┴─────────┴─────────┴─────────┴─────────┴─────────┴─────────┘
  전체 평균 n=6 EXACT: 95.4% (83/87 물리파라미터, 6 엔지니어링 제외)
```
