...
```
  ...
  ║  저장 에너지 (ITER TF)         ║  41 GJ = σ·n/φ+sopfr            ║
  ║  자장 균일도                   ║  <10 ppm = σ-φ ppm              ║
  ║  NMR 보어                      ║  54 mm = σ·τ+n                   ║
  ║  Total n=6 EXACT               ║  13/14 (93%)                    ║
  ╚════════════════════════════════╩═════════════════════════════════╝
```
...
| 총 저장 에너지 | 41 GJ | σ·n/φ+sopfr=36+5=41 | O |
| 총 선재 | ~100,000 km | - | - |
...
|--------|-----------|---------|-----------|---------|
| ITER TF | 15.8 | 68 | 41 | σ·n/φ+sopfr=41 |
...
| 2 | ITER TF 12T | 12 | 핵융합 | 5/6 (83%) | 90 |
| 3 | Hybrid 45T | 45 | 연구 | 4/4 (100%) | 85 |
| 4 | NMR 24T | 24 | 분석 | 4/4 (100%) | 82 |
