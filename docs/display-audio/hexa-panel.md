...
```
  ┌──────────────────────────────────────────────────────────────────────┐
  │                    HEXA-PANEL Array Architecture                     │
  │                                                                      │
  │  ┌──────────── DISPLAY PANEL ────────────┐  ┌── AUDIO ARRAY ──┐    │
  │  │                                        │  │                  │    │
  │  │  ┌─────┬─────┬─────┬─────┬─────┬────┐│  │  ┌──┬──┬──┬──┐  │    │
  │  │  │ Sub │ Sub │ Sub │ Sub │ Sub │ Sub ││  │  │M1│M2│M3│M4│  │    │
  │  │  │ Pix │ Pix │ Pix │ Pix │ Pix │ Pix ││  │  │  │  │  │  │  │    │
  │  │  │ R   │ G   │ B   │ R   │ G   │ B   ││  │  │  │  │  │  │  │    │
  │  │  └─────┴─────┴─────┴─────┴─────┴────┘│  │  ├──┼──┼──┼──┤  │    │
  │  │  n/φ=3 subpixels × σ²=144 row/col    │  │  │M5│M6│M7│M8│  │    │
  │  │  = σ²·(n/φ) = 432 subpixels/row      │  │  │  │  │  │  │  │    │
  │  │                                        │  │  ├──┼──┼──┼──┤  │    │
  │  │  Refresh: σ²=144 Hz                    │  │  │M9│10│11│12│  │    │
  │  │  HDR: σ=12 stops                       │  │  │  │  │  │  │  │    │
  │  │  Color: σ=12 bit/ch                    │  │  └──┴──┴──┴──┘  │    │
  │  │  FPS: J₂=24 cinema / σ·sopfr=60 game  │  │  σ=12 MEMS units│    │
  │  └────────────────────────────────────────┘  │  BW: σ·τ=48kHz  │    │
  │                                               └─────────────────┘    │
...
## 2. Audio Transducer Array

### 2.1 MEMS Speaker Array

```
  ┌──────────────────────────────────────────────────────────────────┐
  │  σ=12 UNIT MEMS SPEAKER ARRAY                                   │
  │                                                                  │
  │  Array layout (σ=12 units in n×φ = 6×2 grid):                  │
  │                                                                  │
  │   ┌────┬────┬────┬────┬────┬────┐                              │
  │   │ M1 │ M2 │ M3 │ M4 │ M5 │ M6 │  ← Left (L)               │
  │   │sub │low │mid │hi  │sub │low │                              │
  │   ├────┼────┼────┼────┼────┼────┤                              │
  │   │ M7 │ M8 │ M9 │M10│M11│M12│  ← Right (R)                  │
  │   │mid │hi  │sub │low│mid │hi │                                │
  │   └────┴────┴────┴────┴────┴────┘                              │
  │                                                                  │
  │  Frequency partitioning (Egyptian fraction):                     │
  │    Sub-bass:  1/n = 1/6 of units (M1, M9)                      │
  │    Bass:      1/n/φ = 1/3 of units (M2, M6, M10)              │
  │    Mid+High:  1/φ = 1/2 of units (M3,M4,M5,M7,M8,M11,M12)    │
  │    Sum: 1/6 + 1/3 + 1/2 = 1 (Egyptian EXACT)                  │
  │                                                                  │
  │  Per-unit BW: σ·τ=48kHz                                        │
  │  Total SPL: σ·sopfr=60 dB at 1m (combined)                     │
  │  Beamforming: n=6 beam directions                               │
  └──────────────────────────────────────────────────────────────────┘
```

---

## 3. Panel Manufacturing Process
...
| MEMS array count | 12 | σ | EXACT |
| Fab steps | 6 | n | EXACT |
| Subpixel count | 3 | n/φ | EXACT |
| Audio sample rate | 48kHz | σ·τ | EXACT (BT-76) |
...
- Next: [HEXA-DRIVER (Level 2)](hexa-driver.md)
