...
> 중간 산출물: `~/Dev/nexus/shared/dse_cross/` (pair_scores.jsonl, all_pairs_s05.jsonl, top10_result.json)
...
| 파일 | 내용 |
|------|------|
| `~/Dev/nexus/shared/dse_cross/pair_scores.jsonl` | combos 상위 50 도메인 1,225쌍 전체 스코어 |
| `~/Dev/nexus/shared/dse_cross/all_pairs_s05.jsonl` | 전체 335 도메인 S≥0.5 236쌍 (수식 포함) |
| `~/Dev/nexus/shared/dse_cross/formula_cross.jsonl` | 수식 패턴별 교차 공명 도메인 |
| `~/Dev/nexus/shared/dse_cross/top10_result.json` | 상위 10쌍 + z-score + p_empirical |
