...
|--------------|------|--------------------------|----------|
| AI 안경 (AR/VR) | Vision Pro 600g, 2시간 | 시각피질 V1~V6(n=6) 직접 영상 주입 | 30g 밴드로 무한 AR |
...
**한 문장 요약**: 두피 밴드 1개로 안경·이어폰·워치·외골격이 전부 사라지고, 마비·치매·우울증·실명이 사라진다.
...
- [x] **웨어러블 통합**: 안경/이어폰/워치/외골격 → BCI 밴드 1개
