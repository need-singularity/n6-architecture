...
| 출처 | 보고 수 | 인용 위치 |
|------|---------|-----------|
| convergence ossified | 17 | `shared/convergence/n6-architecture.json` → `ossified.AI_17_TECHNIQUES` ("17 기법 실험 확정, 71% FLOPs, 3x FFT, 67% param") |
...
- `shared/convergence/n6-architecture.json` `AI_17_TECHNIQUES` 골화 블록은 **변경 금지**(R10 불변성). 이 감사는 새 SSOT 를 생성하지 않고, 16 정의를 stable 블록에 신규 항목으로 추가하는 것을 권장.
...
- `shared/convergence/n6-architecture.json` 라인 20~24 (`AI_17_TECHNIQUES` ossified)
...
- 상위: `../CLAUDE.md`
- 컨버전스: `../../shared/convergence/n6-architecture.json`
