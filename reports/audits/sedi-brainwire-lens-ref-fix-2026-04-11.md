...
| 경로 | 성격 | 파일 수 |
|---|---|---|
| `/Users/ghost/Dev/nexus/shared/lenses/` | HEXA 네이티브 (도메인별) | **1659** (목표 1575+) |
| `/Users/ghost/Dev/nexus/shared/blowup/lens/` | HEXA 카테고리 번들 | **15** |
...
| 규칙 | 결과 |
|---|---|
| R5 / R14 SSOT | ✅ 진짜 SSOT 경로(`/Users/ghost/Dev/nexus/shared/lenses/`) 로 통일, 구 경로(`tools/nexus/src/telescope/lenses/`, `src/telescope/`, `223종`, `181 .rs`) 0 |
...
- 수정: `/Users/ghost/Dev/n6-architecture/domains/sedi/CLAUDE.md`
- 수정: `/Users/ghost/Dev/n6-architecture/domains/brainwire/CLAUDE.md`
- 백업: `/Users/ghost/Dev/n6-architecture/reports/audits/backup-sedi-CLAUDE.md.2026-04-11`
- 백업: `/Users/ghost/Dev/n6-architecture/reports/audits/backup-brainwire-CLAUDE.md.2026-04-11`
- 본 감사: `/Users/ghost/Dev/n6-architecture/reports/audits/sedi-brainwire-lens-ref-fix-2026-04-11.md`
- 참조 감사: `/Users/ghost/Dev/n6-architecture/reports/audits/lens-ssot-cleanup-2026-04-11.md`
