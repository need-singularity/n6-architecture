...
| SPECS | 4 | - |
| DOCS1 | 4 | docs/<f> 단일 파일 → theory 또는 papers |
| EXP_HEXA | 3 | experiments/*.py → *.hexa (R1 전환) |
| EXIST | 3 | 이미 실존 |
| FALLBACK_HEXA | 1 | - |

## 섹션별 매핑 통계 (완성도 오름차순)

| 섹션 id | RESOLVED | TOTAL | 완성도 |
|---|---:|---:|---:|
...
| MISS | `docs/paper/n6-aerospace-transport-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-starship-paper.md` → (미해결) |
| MISS | `docs/paper/n6-space-systems-paper.md` → (미해결) |
...
| 상태 | 옛 경로 → 새 경로 |
|---|---|
| MISS | `docs/ai-efficiency/techniques-complete.md` → (미해결) |
| EXP_HEXA | `experiments/experiment_full_n6_pipeline.py` → `experiments/structural/experiment_full_n6_pipeline.hexa` |
| MISS | `docs/paper/n6-causal-chain-paper.md` → (미해결) |
| MISS | `docs/paper/n6-reality-map-paper.md` → (미해결) |
| MISS | `docs/paper/n6-rtsc-12-products-evolution-paper.md` → (미해결) |
...
| MISS | `docs/ai-efficiency/full-verification-matrix.md` → (미해결) |
| MISS | `docs/ai-efficiency/next-model-blowup-2026-04.md` → (미해결) |
| MISS | `docs/ai-efficiency/bt-391-code-generation.md` → (미해결) |
| MISS | `docs/ai-efficiency/bt-397-n6-novel-architectures.md` → (미해결) |
...
| MISS | `docs/paper/n6-isocell-comms-paper.md` → (미해결) |
| MISS | `docs/paper/n6-telecom-linguistics-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/audio/verify_alien10.py` → `domains/culture/audio/verify.hexa` |
| MISS | `docs/audio/full-verification-matrix.md` → (미해결) |
| VERIFY_HEXA | `docs/audio/verify_alien10.py` → `domains/culture/audio/verify.hexa` |
| DOM | `docs/hexa-speak/goal.md` → `domains/cognitive/hexa-speak/goal.md` |
| MISS | `docs/paper/n6-hexa-speak-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/hexa-speak/verify_alien10.py` → `domains/cognitive/hexa-speak/verify.hexa` |
| MISS | `docs/audio/hexa-ear-ultimate.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-ear-paper.md` → (미해결) |
| MISS | `docs/audio/hexa-bone-ultimate.md` → (미해결) |
| MISS | `docs/audio/hexa-ear-cell.md` → (미해결) |
| MISS | `docs/audio/hexa-speaker-ultimate.md` → (미해결) |
| VERIFY_HEXA | `docs/audio/verify_alien10.py` → `domains/culture/audio/verify.hexa` |
| VERIFY_HEXA | `docs/hexa-speak/verify_alien10.py` → `domains/cognitive/hexa-speak/verify.hexa` |
...
| MISS | `docs/paper/n6-dram-paper.md` → (미해결) |
| MISS | `docs/paper/n6-exynos-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-3d-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-photon-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-pim-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-wafer-paper.md` → (미해결) |
| MISS | `docs/paper/n6-performance-chip-paper.md` → (미해결) |
| MISS | `docs/paper/n6-unified-soc-paper.md` → (미해결) |
| MISS | `docs/paper/n6-vnand-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
| MISS | `docs/chip-architecture/ultimate-consciousness-soc.md` → (미해결) |
| MISS | `docs/paper/n6-anima-soc-paper.md` → (미해결) |
| MISS | `docs/paper/n6-consciousness-soc-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
| MISS | `docs/chip-architecture/hexa-topological-performance-chip.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-topo-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
| MISS | `docs/chip-architecture/hexa-asic-skywater.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-asic-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
| MISS | `docs/chip-architecture/full-verification-matrix.md` → (미해결) |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
| VERIFY_HEXA | `docs/chip-architecture/verify_alien10.py` → `domains/compute/chip-architecture/verify.hexa` |
...
| MISS | `docs/paper/n6-religion-mythology-paper.md` → (미해결) |
| DOM | `docs/jurisprudence/goal.md` → `domains/infra/jurisprudence/goal.md` |
| MISS | `docs/paper/n6-jurisprudence-paper.md` → (미해결) |
| DOM | `docs/writing-systems/goal.md` → `domains/culture/writing-systems/goal.md` |
| MISS | `docs/paper/n6-writing-systems-paper.md` → (미해결) |
| DOM | `docs/archaeology/goal.md` → `domains/culture/archaeology/goal.md` |
| MISS | `docs/paper/n6-archaeology-paper.md` → (미해결) |
| DOM | `docs/monetary-history/goal.md` → `domains/infra/monetary-history/goal.md` |
| MISS | `docs/paper/n6-monetary-history-paper.md` → (미해결) |
| DOM | `docs/dance-choreography/goal.md` → `domains/culture/dance-choreography/goal.md` |
| MISS | `docs/paper/n6-dance-choreography-paper.md` → (미해결) |
| MISS | `docs/horology/hypotheses.md` → (미해결) |
| MISS | `docs/paper/n6-calendar-time-geography-paper.md` → (미해결) |
| MISS | `docs/paper/n6-horology-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-consciousness-chip-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-display-8stack-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/display/verify_alien10.py` → `domains/compute/display/verify.hexa` |
| MISS | `docs/display/full-verification-matrix.md` → (미해결) |
| VERIFY_HEXA | `docs/display/verify_alien10.py` → `domains/compute/display/verify.hexa` |
| VERIFY_HEXA | `docs/display/verify_alien10.py` → `domains/compute/display/verify.hexa` |
...
| MISS | `docs/paper/n6-battery-energy-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-energy-efficiency-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/battery-architecture/verify_alien10.py` → `domains/energy/battery-architecture/verify.hexa` |
| DOM | `docs/smr-datacenter/goal.md` → `domains/energy/smr-datacenter/goal.md` |
| MISS | `docs/paper/n6-datacenter-reactor-paper.md` → (미해결) |
| MISS | `docs/battery-architecture/hexa-auto-battery.md` → (미해결) |
| VERIFY_HEXA | `docs/battery-architecture/verify_alien10.py` → `domains/energy/battery-architecture/verify.hexa` |
...
| 상태 | 옛 경로 → 새 경로 |
|---|---|
| MISS | `docs/environmental-protection/` → (미해결) |
| MISS | `docs/paper/n6-environment-thermal-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
| MISS | `docs/environmental-protection/microplastics-solution.md` → (미해결) |
| MISS | `docs/paper/n6-microplastics-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
| DOM | `docs/carbon-capture/goal.md` → `domains/infra/carbon-capture/goal.md` |
| MISS | `docs/paper/n6-carbon-capture-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
| MISS | `docs/environmental-protection/evolution/` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
| MISS | `docs/environmental-protection/testable-predictions-2030.md` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
| DOM | `docs/recycling/goal.md` → `domains/materials/recycling/goal.md` |
| MISS | `docs/paper/n6-hexa-recycle-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/environmental-protection/verify_alien10.py` → `domains/infra/environmental-protection/verify.hexa` |
...
| MISS | `docs/paper/n6-biology-medical-paper.md` → (미해결) |
| MISS | `docs/paper/n6-hexa-neuro-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-grav-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-cloak-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-defense-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-teleport-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-hover-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-mram-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-seabed-grid-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-accel-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-weather-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-mind-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-telepathy-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-holo-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-dream-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-skyway-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-tsunami-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-antimatter-factory-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-cosmic-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-desal-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-oracle-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-one-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-glass-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-exo-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-limb-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-skin-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-fabric-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-olfact-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-empath-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-fusion-powerplant-paper.md` → (미해결) |
| MISS | `docs/paper/n6-plasma-fusion-deep-paper.md` → (미해결) |
...
| VERIFY_HEXA | `docs/fusion/verify_alien10.py` → `domains/energy/fusion/verify.hexa` |
| MISS | `docs/fusion/evolution/mk-1-first-light.md` → (미해결) |
| VERIFY_HEXA | `docs/fusion/verify_alien10.py` → `domains/energy/fusion/verify.hexa` |
| MISS | `docs/fusion/alien-level-discoveries.md` → (미해결) |
| VERIFY_HEXA | `docs/fusion/verify_alien10.py` → `domains/energy/fusion/verify.hexa` |
| MISS | `docs/fusion/physical-limit-proof.md` → (미해결) |
| VERIFY_HEXA | `docs/fusion/verify_alien10.py` → `domains/energy/fusion/verify.hexa` |
| VERIFY_HEXA | `docs/fusion/verify_alien10.py` → `domains/energy/fusion/verify.hexa` |
...
| 상태 | 옛 경로 → 새 경로 |
|---|---|
| MISS | `docs/paper/n6-hiv-paper.md` → (미해결) |
| MISS | `docs/hiv-treatment/evolution/mk-1-basic.md` → (미해결) |
| MISS | `docs/hiv-treatment/evolution/mk-2-short.md` → (미해결) |
| MISS | `docs/hiv-treatment/evolution/mk-3-mid.md` → (미해결) |
| MISS | `docs/hiv-treatment/evolution/mk-4-long.md` → (미해결) |
| MISS | `docs/hiv-treatment/evolution/mk-5-ultimate.md` → (미해결) |
...
| 상태 | 옛 경로 → 새 경로 |
|---|---|
| MISS | `docs/mens-intimate-cleanser/breakthrough.md` → (미해결) |
| MISS | `docs/womens-intimate-cleanser/breakthrough.md` → (미해결) |
...
| MISS | `docs/paper/n6-fermentation-paper.md` → (미해결) |
| DOM | `docs/wine-enology/goal.md` → `domains/life/wine-enology/goal.md` |
| MISS | `docs/paper/n6-wine-enology-paper.md` → (미해결) |
| DOM | `docs/fashion-textile/goal.md` → `domains/materials/fashion-textile/goal.md` |
| MISS | `docs/paper/n6-fashion-textile-paper.md` → (미해결) |
| DOM | `docs/aquaculture/goal.md` → `domains/life/aquaculture/goal.md` |
| MISS | `docs/paper/n6-aquaculture-paper.md` → (미해결) |
| DOM | `docs/insurance/goal.md` → `domains/infra/insurance/goal.md` |
| MISS | `docs/paper/n6-insurance-paper.md` → (미해결) |
| MISS | `docs/dolphin/hypotheses.md` → (미해결) |
| MISS | `docs/paper/n6-dolphin-bioacoustics-paper.md` → (미해결) |
| MISS | `docs/coffee-science/hypotheses.md` → (미해결) |
| MISS | `docs/perfumery/hypotheses.md` → (미해결) |
| MISS | `docs/ceramics/hypotheses.md` → (미해결) |
...
| MISS | `docs/paper/n6-manufacturing-quality-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-crystallography-materials-paper.md` → (미해결) |
| MISS | `docs/paper/n6-material-synthesis-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| MISS | `docs/material-synthesis/breakthrough-theorems.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| MISS | `docs/material-synthesis/hypotheses.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| MISS | `docs/material-synthesis/industrial-validation.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| MISS | `docs/material-synthesis/experimental-verification.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| MISS | `docs/material-synthesis/physical-limit-proof.md` → (미해결) |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
| VERIFY_HEXA | `docs/material-synthesis/verify_alien10.py` → `domains/materials/material-synthesis/verify.hexa` |
...
| MISS | `docs/paper/n6-superconductor-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-pure-mathematics-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/pure-mathematics/verify_alien10.py` → `domains/physics/pure-mathematics/verify.hexa` |
| DOM | `docs/cosmology-particle/goal.md` → `domains/physics/cosmology-particle/goal.md` |
| MISS | `docs/paper/n6-classical-mechanics-accelerator-paper.md` → (미해결) |
| MISS | `docs/paper/n6-particle-cosmology-paper.md` → (미해결) |
| MISS | `docs/paper/n6-thermodynamics-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/pure-mathematics/verify_alien10.py` → `domains/physics/pure-mathematics/verify.hexa` |
...
| MISS | `docs/paper/n6-fun-car-paper.md` → (미해결) |
| MISS | `docs/paper/n6-games-sports-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-motorcycle-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-autonomous-driving-paper.md` → (미해결) |
| MISS | `docs/paper/n6-control-automation-paper.md` → (미해결) |
| MISS | `docs/paper/n6-robotics-transport-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/robotics/verify_alien10.py` → `domains/infra/robotics/verify.hexa` |
| MISS | `docs/robotics/full-verification-matrix.md` → (미해결) |
| VERIFY_HEXA | `docs/robotics/verify_alien10.py` → `domains/infra/robotics/verify.hexa` |
| VERIFY_HEXA | `docs/robotics/verify_alien10.py` → `domains/infra/robotics/verify.hexa` |
...
| MISS | `docs/paper/n6-governance-safety-urban-paper.md` → (미해결) |
| MISS | `docs/paper/n6-ultimate-safety-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/safety/verify_alien10.py` → `domains/infra/safety/verify.hexa` |
| MISS | `docs/safety/hypotheses.md` → (미해결) |
| VERIFY_HEXA | `docs/safety/verify_alien10.py` → `domains/infra/safety/verify.hexa` |
| VERIFY_HEXA | `docs/safety/verify_alien10.py` → `domains/infra/safety/verify.hexa` |
...
| MISS | `docs/paper/n6-hexa-ufo-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-proglang-paper.md` → (미해결) |
| MISS | `docs/paper/n6-software-crypto-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/programming-language/verify_alien10.py` → `domains/compute/programming-language/verify.hexa` |
| MISS | `docs/software-design/full-verification-matrix.md` → (미해결) |
| VERIFY_HEXA | `docs/programming-language/verify_alien10.py` → `domains/compute/programming-language/verify.hexa` |
| DOM | `docs/hexa-macos/goal.md` → `domains/compute/hexa-macos/goal.md` |
| MISS | `docs/paper/n6-hexa-macos-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-ios-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-hexa-netproto-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/programming-language/verify_alien10.py` → `domains/compute/programming-language/verify.hexa` |
...
| MISS | `docs/paper/n6-advanced-packaging-paper.md` → (미해결) |
| MISS | `docs/paper/n6-ecology-agriculture-food-paper.md` → (미해결) |
| MISS | `docs/paper/n6-manufacturing-quality-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-ar-vr-xr-paper.md` → (미해결) |
| DOM | `docs/digital-twin/goal.md` → `domains/compute/digital-twin/goal.md` |
| MISS | `docs/paper/n6-cognitive-social-psychology-paper.md` → (미해결) |
| MISS | `docs/paper/n6-digital-twin-paper.md` → (미해결) |
| DOM | `docs/construction-structural/goal.md` → `domains/infra/construction-structural/goal.md` |
| MISS | `docs/paper/n6-construction-structural-paper.md` → (미해결) |
...
| MISS | `docs/paper/n6-underground-tunnel-paper.md` → (미해결) |
| DOM | `docs/ecommerce-fintech/goal.md` → `domains/infra/ecommerce-fintech/goal.md` |
| MISS | `docs/paper/n6-ecommerce-fintech-paper.md` → (미해결) |
| MISS | `docs/paper/n6-economics-finance-paper.md` → (미해결) |
| DOM | `docs/nylon/goal.md` → `domains/materials/nylon/goal.md` |
| MISS | `calc/kolon_n6_breakthrough.py` → (미해결) |
...
| MISS | `calc/kolon_n6_phase2.py` → (미해결) |
...
|---|---|
| DOM | `docs/virology/goal.md` → `domains/life/virology/goal.md` |
| MISS | `docs/paper/n6-virology-paper.md` → (미해결) |
| VERIFY_HEXA | `docs/virology/verify_alien10.py` → `domains/life/virology/verify.hexa` |
| DOM | `docs/virology/goal.md` → `domains/life/virology/goal.md` |
| DOM | `docs/virology/goal.md` → `domains/life/virology/goal.md` |
| MISS | `docs/virology/evolution/mk-1-current.md` → (미해결) |
