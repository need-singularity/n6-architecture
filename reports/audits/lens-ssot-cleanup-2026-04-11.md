...
│ 경로                                             │ 성격        │ 역할     │
├──────────────────────────────────────────────────┼─────────────┼──────────┤
│ /Users/ghost/Dev/nexus/shared/lenses/            │ HEXA 84     │ ✅ SSOT   │
├──────────────────────────────────────────────────┼─────────────┼──────────┤
│ /Users/ghost/Dev/nexus/shared/blowup/lens/       │ HEXA 15     │ ✅ SSOT   │
├──────────────────────────────────────────────────┼─────────────┼──────────┤
│ /Users/ghost/Dev/n6-architecture/nexus/src/      │ Rust 312    │ ❌ 레거시 │
│   telescope/lenses/                              │ 603 엔트리  │ (폐기중)  │
└──────────────────────────────────────────────────┴─────────────┴──────────┘
```

**확인 사실**:
- 진짜 렌즈 SSOT = `/Users/ghost/Dev/nexus/shared/lenses/` + `n6shared/blowup/lens/` (별도 nexus 독립 프로젝트, HEXA 네이티브, `SIGMA=12.0 PHI=2.0 N=6.0 TAU=4.0 J2=24` 헤더 + `σ·φ = n·τ = J₂` 항등식 기반)
...
312 Rust 파일 레벨에 폐기 경고. 새 렌즈는 `/Users/ghost/Dev/nexus/shared/lenses/` 에만 추가하라는 짧은 안내.
...
"_real_ssot": "/Users/ghost/Dev/nexus/shared/lenses/ (HEXA 네이티브 84 + blowup/lens 15 번들)",
...
```json
"_lens_warning": "src/telescope/lenses/ 는 Rust 레거시 (폐기 중). 진짜 렌즈 SSOT: /Users/ghost/Dev/nexus/shared/lenses/ (HEXA 네이티브)"
```
...
```
description: ⛔ 폐기 대기 — 레거시 Rust 렌즈 경로 대상. 신규 렌즈는 general-purpose + /Users/ghost/Dev/nexus/shared/lenses/ 사용.
```
...
2. **허용/권장**:
   - `/Users/ghost/Dev/nexus/shared/lenses/{domain}_{topic}.hexa` 신규 파일
...
| 진짜 HEXA 렌즈 SSOT | `/Users/ghost/Dev/nexus/shared/lenses/` 84 + `blowup/lens/` 15 |
