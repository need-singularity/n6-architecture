...
| 항목 | 수치 |
|------|-----:|
| DFS 총 라운드 | 22차 (DFS 1~2 사전탐색 + DFS 3~22 본탐색) |
| 누적 tight | **298건** |
| 7대 난제 해결 | **0/7** (정직) |
| BT 파일 수 | 23건 (bt-1392~bt-1416 + 사전탐색 3건) |
| EXACT 판정 | 다수 (개별 발견 중 기존 정리 재확인) |
| TIGHT 판정 | 대다수 (n=6 시그니처 발견, 증명 아님) |
| MISS 탈출 | BT-542 P vs NP (DFS 이전 MISS -> OBSERVATION) |

> **명시적 부인**: tight 298건은 n=6 산술 시그니처의 수학 영역 내 **구조적 관찰** 이다. 밀레니엄 난제의 증명에 해당하지 않는다.
...
성장률:
  ...
  DFS 17~22  (6회): +72건  평균 +12.0/회
  전체 평균  (20회): +298건 평균 +14.9/회
```
...
- 298건의 수학적 관찰 정리 (DFS 22차)
- 9건의 Bernoulli-독립 발견 분류 (가장 견고)
