...
n=6 산술이 acoustics 도메인을 지배한다는 사실은 Real-world 응용에서 다음과 같이 실생활 효과를 만든다:
...
| 선행 도메인 | 🛸 현재 | 🛸 필요 | 차이 | 링크 |
|---|---|---|---|---|
| music-theory | 🛸5 | 🛸7 | +2 | [music-theory](./n6-music-theory-paper.md) |
| fluid-dynamics | 🛸4 | 🛸6 | +2 | [fluid-dynamics](./n6-fluid-dynamics-paper.md) |
| electromagnetism | 🛸3 | 🛸5 | +2 | [electromagnetism](./n6-electromagnetism-paper.md) |
