...
requires:
  ...
  - to: chemistry
---
# [CANONICAL v2] n=6 arithmetic coordinate mapping for Construction & Structural (HEXA-CONSTRUCTION-STR)

> **Author**: Park Minwoo (n6-architecture)
> **Category**: construction-structural — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Prior BT**: BT-143, BT-201, BT-149, BT-189, BT-130
> **Connected atlas node**: `construction-structural` 22/25 EXACT [10*]

---

## 0. Abstract

This paper examines whether the core parameters of the construction & structural domain are
...
tightly linked to the basic numerical parameters of the construction & structural domain. atlas.n6
records 22/25 entries as EXACT.

This paper does not claim a new construction & structural formulation; it is a seed document that
...
Construction & Structural (construction-structural) is re-interpreted inside the n=6 arithmetic system. The perfect
number n=6 simultaneously satisfies the number-theoretic constants σ(6)=12, τ(6)=4, φ=2,
sopfr(6)=5, which is structurally consistent with the core parameters of the construction & structural
domain. **This paper overlays an n=6 arithmetic coordinate system on the existing body
of construction & structural knowledge.**

| Effect | Baseline | After HEXA-CONSTRUCTION-STRUCTURAL | Observed change |
|--------|----------|--------------|------------------|
...
uniqueness is tightly linked to the basic numerical parameters of the construction & structural domain.

### What the n=6 coordinate mapping changes

```
  Baseline: "why is this construction & structural value that specific number?" -> experience/convention
  HEXA:     "this construction & structural value = σ(6) or τ(6) or sopfr(6)"   -> number-theoretic necessity
       ↓
...
## §2 COMPARE (baseline construction & structural vs n=6) — performance comparison (ASCII)
...
### Performance comparison ASCII bars (baseline construction & structural vs HEXA-CONSTRUCTION-STRUCTURAL)
...
|---------------|---------------|--------------|------|----------------|------|
| classical-mechanics-accelerator | alien 5~7 | alien 10 | +3~5 | child-domain n=6 alignment | [doc](../domains/classical-mechanics-accelerator/classical-mechanics-accelerator.md) |
| aerospace-transport | alien 5~7 | alien 10 | +3~5 | child-domain n=6 alignment | [doc](../domains/aerospace-transport/aerospace-transport.md) |
| chemistry | alien 5~7 | alien 10 | +3~5 | child-domain n=6 alignment | [doc](../domains/chemistry/chemistry.md) |
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│                    HEXA-CONSTRUCTION-STR  system structure     │
├────────────┬────────────┬────────────┬────────────┬─────────────────────┤
...
4. **Domain overlap**: the σ=12 axis is a shared parameter across dozens of domains beyond construction & structural.
...
│  Input : construction & structural raw data           │
...
Stage-by-stage maturity roadmap for HEXA-CONSTRUCTION-STR — verification density grows per Mk:

<details open>
<summary><b>Mk.V — 2045+ integration target</b></summary>

Target: full integration of the construction & structural domain under n=6 arithmetic. Cross-reference
...
Core construction & structural parameters mapped onto σ/τ/φ/sopfr/J₂.
...
Verify, using stdlib only, whether HEXA-CONSTRUCTION-STR is consistent with physics / mathematics /
...
Check via log-log regression whether the main construction & structural scaling law follows
...
The construction & structural domain physics bounds (Carnot / Shannon / Bekenstein etc.) are checked
separately.

### §7.6 CHI2 — H₀: n=6 coincidence hypothesis p-value
Compute 22/25 EXACT under H₀ (random match) -> p-value.
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-CONSTRUCTION-STR n=6 honesty check (stdlib only, construction-structural domain)
#
# 10-section layout:
...
FALSIFIERS = [
    "retire the main draft if construction & structural parameter n=6 alignment drops below 70%",
    "retire the uniqueness claim if sigma(n)*phi(n) = n*tau(n) is observed at n != 6",
    "downgrade to Mk.I if atlas 22/25 EXACT re-measurement falls below 70%",
