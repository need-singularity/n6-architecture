...
- `shared/n6/atlas.n6` 11013~11055 — `n6-atlas-sle₆-&-pure-mathematics-bt-105~109` 23 노드 [10*]
...
| n6-superconductor-paper.md | physics | ghost (잔존) |
| n6-particle-cosmology-paper.md | physics | ghost (잔존) |

본 시드는 6편 중 1편. 잔존 86건은 후속 세션에서 동일 패턴으로 작성한다.
