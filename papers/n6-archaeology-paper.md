...
- `n6shared/n6/atlas.n6` 라인 11013~11055 — pure-mathematics 23 노드 (간접 근거)
...
n=6 산술이 archaeology 도메인을 지배한다는 사실은 Real-world 응용에서 다음과 같이 실생활 효과를 만든다:
...
| chemistry | 🛸4 | 🛸6 | +2 | [chemistry](./n6-chemistry-paper.md) |
| cartography | 🛸3 | 🛸5 | +2 | [cartography](./n6-cartography-paper.md) |
